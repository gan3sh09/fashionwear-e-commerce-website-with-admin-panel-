...
<body>
    ...
    <div class="container">
        <h2>Welcome Back!</h2><h3>One of Us? Login</h3>
        <form action="handler/customerlogin.php" class="sign-in-form" method="POST">
            ...
            <p>New User? <a href="signupform.php">Create an account</a></p>
        </form>
