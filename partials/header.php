...
<header>
			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="right-top-bar flex-w h-full">
						...
						<h5><i class="fa fa-user" aria-hidden="true"></i>   Logout</h5>	
						
						
							</a>
						<?php }else{ ?>
						<a href="signinform.php" class="flex-c-m trans-04 p-lr-25">
						<h5><i class="fa fa-user" aria-hidden="true"></i>   Login</h5>
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<a href="index.php" class="logo">
						<img src="images/icons/logoXYZ.png" alt="IMG-LOGO">
					</a>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="index.php"><img src="images/icons/logoXYZ.png" alt="IMG-LOGO"></a>
			</div>
